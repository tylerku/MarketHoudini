...
var FbmService = /** @class */ (function () {
    ...
    FbmService.prototype._login = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.page.goto('https://www.facebook.com', { waitUntil: 'networkidle0' })];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.page.type('#email', '7244064427')];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.page.type('#pass', 'MilesCity94!')];
                    case 3:
                        _a.sent();
